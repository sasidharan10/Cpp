...
int main()
{
    ...
    *p=b;
    cout<<"\np : "<<p<<endl; // we can see since only the value is changed but the address remains same
    cout<<"*p : "<<*p<<endl;
...
// pointerss and variables should have dame datatype because pointer is used to dereference the variabes also
