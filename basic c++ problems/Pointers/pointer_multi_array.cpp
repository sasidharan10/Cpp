...
// for 2d arrray atleast mention size for column during declaration
// if a 2D array statement has 2 '*' symbols, the its definetly a value as it is dereferenced twice.
// or if it has 1 '*' symbol and one a[0] then also it returns a value as it is also dereferenced twice.
// normal addtion to the variable just pushes it to next element or next row