...
int main()
{
    ...
    cout << "Largest Perimeter: " << s.largestPerimeter(nums) << endl;
    return 0;
}
...
Youtube: https://www.youtube.com/watch?v=3RUkd0SPnPk
...
because it is not possible to include 2 or more smaller sides that
have a greater sum than either of them.
...
Input: nums = [5,5,50]
Output: -1
Explanation: There is no possible way to form a polygon from nums, as
a polygon has at least 3 sides and 50 > 5 + 5.
