...
int main()
{
    ...
    int m = 2, k = 3;
    cout << "Minimum Number of Days to Make m Bouquets: " << s.minDays(bloomDay, m, k) << endl;
    return 0;
}
...
flowers. We only have 5 flowers so it is impossible to get the needed bouquets and we return -1.
Example 3:
