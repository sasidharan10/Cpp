...
int main()
{
    ...
    // int power = 150;
    cout << "Result: " << s.bagOfTokensScore(nums, power) << endl;
    return 0;
}
...
Youtube: https://www.youtube.com/watch?v=LCx1WzlYgvw
...
bag of tokens given as an integer array tokens, where each tokens[i]
...
face-down. You also cannot play it face-up since your power (50) is less than tokens[0] (100).
...
Explanation: Play token1 (100) face-up, reducing your power to 50
